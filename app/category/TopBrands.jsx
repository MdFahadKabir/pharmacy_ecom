...
const TopBrands = () => {
  ...
  return (
    <section className="lg:px-[65px] px-4">
      <div className="flex items-center text-textDeepSemi py-5">
        {" "}
        <div className="flex items-center gap-2">
          <Image
            ...
            src="/gsk.png"
          />
          <p className="text-base font-semibold">Glaxosmithkline </p>
        </div>
        <p>
          <GoDotFill />
        </p>{" "}
        <p className="font-medium text-sm">255 Products Available</p>
      </div>
