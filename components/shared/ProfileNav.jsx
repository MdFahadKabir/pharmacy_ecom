...
const ProfileNav = () => {
  return (
    <>
      <div className="border border-gray-100 rounded-[10px] shadow-sm w-[28%] h-full lg:flex flex-col hidden">
        ...
        <div className="text-[#718096] font-light text-base">
          <Link
          ...
          <Link
            href=""
            className=" text-gray-400 flex items-center gap-3 ps-7  border-t py-2.5 hover:bg-secondary border-gray-100"
          >
            <p>Legal & Support</p>
          </Link>
          ...
          <Link
            href="/accounts/terms"
            className="flex items-center gap-3 ps-7  border-t py-2.5 hover:bg-secondary border-gray-300"
          >
            <Image
              height={200}
              width={200}
